;; sicp-2-19.ss: Consider the change-counting program of section 1.2.2. It
;; would be nice to be able to easily change the currency used by the program,
;; so that we could compute the number of ways to change a British pound,
;; for example. As the program is written, the knowledge of the currency is
...
;; The order of the list does not affect the answer produced by cc
