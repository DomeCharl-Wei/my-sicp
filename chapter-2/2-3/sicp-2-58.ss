;; sicp-2-58: Suppose we want to modify the differentiation program so that it
;; works with ordinary mathematical notation, in which + and * are infix
...
;; and constructors that define the representation of the algebraic
